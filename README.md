...
### For this tutorial/demo, need to have [mongocryptd](https://www.mongodb.com/docs/v6.1/core/queryable-encryption/reference/mongocryptd/) properly configured. This is a critical step
